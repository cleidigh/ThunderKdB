...
var iOSNotesObj = {
	...
	initDialog : function() {
        document.addEventListener("dialogaccept", function() {iOSNotesObj.exitDialog(false)}); // This replaces ondialogaccept in XUL.
        document.addEventListener("dialogcancel", function() {iOSNotesObj.exitDialog(true)}); // This replaces ondialogcancel in XUL.
    ...
    showSettings : function() {
        window.openDialog("chrome://iOSNotes/content/settings.xul", "chrome");
    }
};
