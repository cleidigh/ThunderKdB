...
var gc_functions = {
    ...
    _g_cond_g1_83: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nTokenOffset], "|je|tu|il|on|elle|iel|nous|vous|ils|elles|iels|");
    },
    ...
    _g_cond_g2_193: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! lToken[nTokenOffset+3]["sValue"].gl_isTitle() && ! g_value(lToken[nTokenOffset], "|un|");
    },
    _g_cond_g2_194: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! lToken[nTokenOffset+3]["sValue"].gl_isTitle() && ! g_value(lToken[nTokenOffset], "|une|");
    },
    ...
    _g_cond_g2_196: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_tag(lToken[nTokenOffset+2], "_Maj_");
    },
    ...
    _g_cond_g2_236: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return lToken[nLastToken-1+1]["sValue"].gl_isLowerCase() && ! g_value(lToken[nLastToken-1+1], "|sont|peu|") && ! g_value(lToken[nTokenOffset+2], "|peu|tout|toute|tous|toutes|");
    },
    ...
    _g_cond_g2_313: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nTokenOffset], "|les|des|à|par|");
    },
    ...
    _g_da_ig12b_8: function (lToken, nTokenOffset, nLastToken) {
        return g_select(lToken[nTokenOffset+2], ":A") && g_select(lToken[nTokenOffset+3], "", ":N");
    },
    ...
    _g_cond_g3_125: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+3], ":[NA].*:[me]:[si]", ":3[sp]") && ! g_agreement(lToken[nTokenOffset+3], lToken[nTokenOffset+5]);
    },
    ...
    _g_cond_g3_140: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+3], ":[NA].*:[fe]:[si]", ":3[sp]") && ! g_agreement(lToken[nTokenOffset+3], lToken[nTokenOffset+5]);
    },
    ...
    _g_cond_g3_210: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+3], ":[NA].*:[pi]", ":3[sp]") && ! g_agreement(lToken[nTokenOffset+3], lToken[nTokenOffset+5]) && ! (g_value(lToken[nLastToken+1], "|et|") && g_morph(lToken[nLastToken-1+1], "#G") && g_morph(g_token(lToken, nLastToken+2), "#G"));
    },
    ...
    _g_cond_g3_298: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":[NA].*:[me]:[si]") && g_morph(lToken[nTokenOffset+5], ":[NA].*:[me]:[si]", ":V0") && ! (g_value(lToken[nTokenOffset], "|,|") && g_morph(g_token(lToken, nTokenOffset+1-2), ":[NA]"));
    },
    ...
    _g_cond_g3_299: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":[NA].*:m:[si]") && g_morph(lToken[nTokenOffset+5], ":[NA].*:f:[si]", ":V0") && ! (g_value(lToken[nTokenOffset], "|,|") && g_morph(g_token(lToken, nTokenOffset+1-2), ":[NA]"));
    },
    ...
    _g_cond_g3_300: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":[NA].*:f:[si]") && g_morph(lToken[nTokenOffset+5], ":[NA].*:m:[si]", ":V0") && ! (g_value(lToken[nTokenOffset], "|,|") && g_morph(g_token(lToken, nTokenOffset+1-2), ":[NA]"));
    },
    _g_cond_g3_301: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":[NA].*:f:[si]") && g_morph(lToken[nTokenOffset+5], ":[NA].*:f:[si]", ":V0") && ! (g_value(lToken[nTokenOffset], "|,|") && g_morph(g_token(lToken, nTokenOffset+1-2), ":[NA]"));
    },
