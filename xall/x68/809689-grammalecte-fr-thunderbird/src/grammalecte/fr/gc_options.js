...
var gc_options = {
    ...
    oColorType: {'aHSL': {'orange': [30, 70, 50], 'orange2': [40, 90, 50], 'violet': [270, 45, 35], 'bleu': [210, 50, 50], 'bleupr': [240, 40, 60], 'fuchsia': [300, 30, 40], 'cyan': [180, 50, 40], 'grey': [0, 50, 50], 'orange_vif': [30, 100, 60], 'jaune_vif': [55, 100, 45], 'violet_vif': [270, 100, 70], 'bleu_vif': [210, 100, 50], 'vert_vif': [120, 100, 40], 'cyan_vif': [180, 100, 40], 'bleupr_clair': [240, 70, 70]}, 'sCSS': {'orange': 'hsl(30, 70%, 50%)', 'orange2': 'hsl(40, 90%, 50%)', 'violet': 'hsl(270, 45%, 35%)', 'bleu': 'hsl(210, 50%, 50%)', 'bleupr': 'hsl(240, 40%, 60%)', 'fuchsia': 'hsl(300, 30%, 40%)', 'cyan': 'hsl(180, 50%, 40%)', 'grey': 'hsl(0, 50%, 50%)', 'orange_vif': 'hsl(30, 100%, 60%)', 'jaune_vif': 'hsl(55, 100%, 45%)', 'violet_vif': 'hsl(270, 100%, 70%)', 'bleu_vif': 'hsl(210, 100%, 50%)', 'vert_vif': 'hsl(120, 100%, 40%)', 'cyan_vif': 'hsl(180, 100%, 40%)', 'bleupr_clair': 'hsl(240, 70%, 70%)'}, 'aRGB': {'orange': [217, 128, 38], 'orange2': [242, 166, 13], 'violet': [89, 49, 129], 'bleu': [64, 127, 191], 'bleupr': [112, 112, 194], 'fuchsia': [133, 71, 133], 'cyan': [51, 153, 153], 'grey': [191, 64, 64], 'orange_vif': [255, 153, 51], 'jaune_vif': [230, 210, 0], 'violet_vif': [178, 102, 255], 'bleu_vif': [0, 127, 255], 'vert_vif': [0, 204, 0], 'cyan_vif': [0, 204, 204], 'bleupr_clair': [125, 125, 232]}, 'nInt': {'orange': 14254118, 'orange2': 15902221, 'violet': 5845377, 'bleu': 4227007, 'bleupr': 7368898, 'fuchsia': 8734597, 'cyan': 3381657, 'grey': 12533824, 'orange_vif': 16750899, 'jaune_vif': 15127040, 'violet_vif': 11691775, 'bleu_vif': 32767, 'vert_vif': 52224, 'cyan_vif': 52428, 'bleupr_clair': 8224232}},
