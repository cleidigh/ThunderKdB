...
var gc_options = {
    ...
    lStructOpt: [['basic', [['typo', 'apos', 'eepi'], ['esp', 'tab'], ['nbsp', 'unit'], ['tu', 'maj', 'minis'], ['num', 'nf'], ['virg', 'poncfin'], ['ocr', 'chim'], ['liga', 'mapos']]], ['gramm', [['conf', 'sgpl', 'gn']]], ['verbs', [['infi', 'conj', 'ppas'], ['imp', 'inte', 'vmode']]], ['style', [['bs', 'pleo'], ['eleu', 'neg'], ['redon1', 'redon2']]], ['misc', [['date', 'mc']]], ['debug', [['idrule']]]],

    dOpt: {
        "JavaScript": new Map ([["typo", true], ["apos", true], ["eepi", true], ["esp", false], ["tab", false], ["nbsp", false], ["tu", true], ["maj", true], ["minis", true], ["num", true], ["virg", true], ["poncfin", false], ["unit", false], ["nf", true], ["liga", false], ["mapos", false], ["chim", true], ["ocr", false], ["conf", true], ["sgpl", true], ["gn", true], ["infi", true], ["conj", true], ["ppas", true], ["imp", true], ["inte", true], ["vmode", true], ["bs", true], ["pleo", true], ["eleu", true], ["neg", false], ["redon1", false], ["redon2", false], ["date", true], ["mc", false], ["idrule", false], ["html", true], ["latex", false], ["md", true]]),
        ...
        "Thunderbird": new Map ([["typo", true], ["apos", true], ["eepi", true], ["esp", false], ["tab", false], ["nbsp", false], ["tu", true], ["maj", true], ["minis", true], ["num", true], ["virg", true], ["poncfin", false], ["unit", false], ["nf", true], ["liga", false], ["mapos", false], ["chim", true], ["ocr", false], ["conf", true], ["sgpl", true], ["gn", true], ["infi", true], ["conj", true], ["ppas", true], ["imp", true], ["inte", true], ["vmode", true], ["bs", true], ["pleo", true], ["eleu", true], ["neg", false], ["redon1", false], ["redon2", false], ["date", true], ["mc", false], ["idrule", false], ["html", true], ["latex", false], ["md", false]]),
    },
