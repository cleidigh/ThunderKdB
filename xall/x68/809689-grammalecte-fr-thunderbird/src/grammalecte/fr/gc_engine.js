...
if (typeof(process) !== 'undefined') {
    ...
    var gc_rules_graph = require("resource://grammalecte/fr/gc_rules_graph.js");
...
const oEvalFunc = {
    ...
    _g_cond_ocr_1: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return lToken[nTokenOffset+1]["sValue"].gl_isTitle() && look(sSentence.slice(0,lToken[1+nTokenOffset]["nStart"]), "[a-zA-Zà-öÀ-Ö0-9_ø-ÿØ-ßĀ-ʯﬁ-ﬆᴀ-ᶿ]") && (g_morph(lToken[nTokenOffset+1], ":G", ":M") || g_morph(lToken[nTokenOffset+1], ":[123][sp]", ":[MNA]|>Est/"));
    },
    ...
    _g_cond_g1_3: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return lToken[nTokenOffset+1]["sValue"] != "SE" && g_space_between_tokens(lToken[nTokenOffset+1], lToken[nTokenOffset+1+1], 1, 1) && g_morph(lToken[nTokenOffset+2], ":V", ":Q");
    },
    ...
    _g_cond_g1_70: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":[123][sp]", ">appeler/|:[NA]") && ! g_value(lToken[nTokenOffset], "|que|qu’|") && ! (g_value(lToken[nTokenOffset], "|ne|n’|") && g_value(g_token(lToken, nTokenOffset+1-2), "|que|qu’|"));
    },
    ...
    _g_sugg_g1_25: function (lToken, nTokenOffset, nLastToken) {
        return lToken[nTokenOffset+1]["sValue"].replace(/a/g, "on");
    },
    ...
    _g_cond_g1_140: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nTokenOffset], "|dont|l’|d’|sauf|excepté|") && ! look(sSentence.slice(0,lToken[1+nTokenOffset]["nStart"]), "(?i)\\bun à +$");
    },
    ...
    _g_cond_g1_152: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! lToken[nTokenOffset+3]["sValue"].gl_isTitle() && ! g_value(lToken[nTokenOffset], "|plus|moins|un|une|");
    },
    ...
    _g_cond_g1_209: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! (g_value(lToken[nTokenOffset+2], "|ou|") && g_value(lToken[nLastToken+1], "|son|ses|"));
    },
    ...
    _g_cond_g1_227: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_morph(lToken[nTokenOffset], ":R|>(?:approcher|cap|passage|programme|terme|classe|autour|celui|ceux|celle|celles)/") && ! g_value(lToken[nLastToken+1], "|de|du|des|d’|") && lToken[nTokenOffset+2]["sValue"] != "35";
    },
    ...
    _g_sugg_g1_114: function (lToken, nTokenOffset, nLastToken) {
        return lToken[nTokenOffset+2]["sValue"].replace(/réso/g, "raiso");
    },
    ...
    _g_cond_g1_362: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_morph(lToken[nTokenOffset], ":Ov|>(?:il|on|elle)");
    },
    ...
    _g_cond_g1_364: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_morph(lToken[nTokenOffset], ":(?:X|Oo)") && ! g_tag_before(lToken[nTokenOffset+1], dTags, "_2s_");
    },
    ...
    _g_cond_g1_385: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":M") && ! look(sSentence.slice(0,lToken[1+nTokenOffset]["nStart"]), "\\b(?:plus|moins|aussi) .* que +$");
    },
    _g_tp_g1_4: function (lToken, nTokenOffset, nLastToken) {
    ...
    _g_cond_g1_406: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! (lToken[nTokenOffset+2]["sValue"] == "bien" && g_value(lToken[nLastToken+1], "|que|qu’|")) && ! (lToken[nTokenOffset+2]["sValue"] == "tant" && g_value(lToken[nLastToken+1], "|est|"));
    },
    ...
    _g_cond_pp2_5: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_morph(lToken[nTokenOffset], ":D") && ! g_morph(lToken[nLastToken+1], ":[NA].*:[fe]:[si]");
    },
    _g_cond_pp2_6: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_morph(lToken[nTokenOffset], ":R|>d’/");
    },
    ...
    _g_cond_g2_2: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_tag_before(lToken[nTokenOffset+1], dTags, "_propsub_") && ! g_morph(lToken[nTokenOffset+1], ":Y") && ! g_value(lToken[nLastToken+1], "|été|");
    },
    ...
    _g_cond_g2_10: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset], ":C|<start>") || g_value(lToken[nTokenOffset], "|,|");
    },
    ...
    _g_cond_g2_37: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_tag_before(lToken[nTokenOffset+1], dTags, "_2p_");
    },
    ...
    _g_sugg_g2_43: function (lToken, nTokenOffset, nLastToken) {
        return lToken[nTokenOffset+1]["sValue"].replace(/û/g, "u").replace(/t/g, "tt");
    },
    ...
    _g_cond_g2_60: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! look(sSentence.slice(0,lToken[1+nTokenOffset]["nStart"]), "[aA]ccompl|[dD]él[éè]gu");
    },
    ...
    _g_cond_g2_78: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+1], ":D") && ! g_value(lToken[nTokenOffset], "|et|ou|de|") && ! lToken[nTokenOffset+3]["sValue"].startsWith("seul");
    },
    ...
    _g_cond_g2_81: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":D") && ! g_morph(lToken[nTokenOffset], ":[NA]") && ! lToken[nTokenOffset+4]["sValue"].startsWith("seul");
    },
    ...
    _g_cond_g2_89: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+1], ":D") && ! g_value(lToken[nTokenOffset], "|et|ou|de|d’|") && ! lToken[nTokenOffset+3]["sValue"].startsWith("seul");
    },
    ...
    _g_cond_g2_91: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":D") && ! g_morph(lToken[nTokenOffset], ":[NA]|>(?:et|ou)/") && ! lToken[nTokenOffset+4]["sValue"].startsWith("seul");
    },
    ...
    _g_cond_g2_110: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nTokenOffset], "|et|ou|d’|") && ! lToken[nTokenOffset+3]["sValue"].startsWith("seul");
    },
    ...
    _g_cond_g2_112: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_morph(lToken[nTokenOffset], ":[NA]|>(?:et|ou)/") && ! lToken[nTokenOffset+4]["sValue"].startsWith("seul");
    },
    ...
    _g_cond_g2_120: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nTokenOffset], "|et|ou|de|d’|") && ! lToken[nTokenOffset+3]["sValue"].startsWith("seul");
    },
    ...
    _g_cond_g2_130: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_morph(lToken[nTokenOffset], ":[NAQ]|>(?:et|ou)/") && ! lToken[nTokenOffset+4]["sValue"].startsWith("seul");
    },
    ...
    _g_cond_g2_134: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nTokenOffset], "|et|ou|") && g_morph(lToken[nTokenOffset+2], ":[NA].*:[si]") && g_morph(lToken[nTokenOffset+3], ":[NA].*:[si]", ":(?:[123][sp]|G|P)") && g_morph(lToken[nTokenOffset+4], ":[NA].*:p", "*") && lToken[nTokenOffset+4]["sValue"].gl_isLowerCase();
    },
    _g_cond_g2_135: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ( g_morph(lToken[nTokenOffset+3], ":[NA].*:s", "*") && ! (g_value(lToken[nLastToken+1], "|et|ou|") && g_morph(g_token(lToken, nLastToken+2), ":[NA]")) ) || aREGULARPLURAL.has(lToken[nTokenOffset+3]["sValue"]);
    },
    ...
    _g_cond_g2_136: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":D") && ( g_morph(lToken[nTokenOffset+3], ":[NA].*:s", "*") || (g_morph(lToken[nTokenOffset+3], ":[NA].*:s", ":[pi]|>avoir/") && g_morph(lToken[nTokenOffset+1], ":[RC]", ">(?:e[tn]|ou)/") && ! (g_morph(lToken[nTokenOffset+1], ":Rv") && g_morph(lToken[nTokenOffset+3], ":Y"))) ) && ! (g_value(lToken[nLastToken+1], "|et|ou|") && g_morph(g_token(lToken, nLastToken+2), ":[NA]")) && ! (g_value(lToken[nTokenOffset+1], "|que|") && g_morph(lToken[nTokenOffset], ">tel/") && g_morph(lToken[nTokenOffset+3], ":3[sp]"));
    },
    _g_cond_g2_137: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ( g_morph(lToken[nTokenOffset+3], ":[NA].*:s", ":[ipYPGW]") && ! (g_value(lToken[nLastToken+1], "|et|ou|") && g_morph(g_token(lToken, nLastToken+2), ":[NA]")) ) || aREGULARPLURAL.has(lToken[nTokenOffset+3]["sValue"]);
    },
    ...
    _g_cond_g2_139: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":D") && ! g_morph(lToken[nTokenOffset], ":[NA]") && ! lToken[nTokenOffset+3]["sValue"].startsWith("seul");
    },
    ...
    _g_cond_g2_141: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return (g_morph(lToken[nTokenOffset+2], ":[NA].*:s", ":(?:[ipGW]|[123][sp])") && ! (g_value(lToken[nLastToken+1], "|et|ou|") && g_morph(g_token(lToken, nLastToken+2), ":[NA]"))) || aREGULARPLURAL.has(lToken[nTokenOffset+2]["sValue"]);
    },
    ...
    _g_cond_g2_142: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return (g_morph(lToken[nTokenOffset+2], ":[NA].*:s", ":[ipGW]") && ! (g_value(lToken[nLastToken+1], "|et|ou|") && g_morph(g_token(lToken, nLastToken+2), ":[NA]"))) || aREGULARPLURAL.has(lToken[nTokenOffset+2]["sValue"]);
    },
    ...
    _g_cond_g2_146: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nTokenOffset], "|et|ou|de|d’|au|aux|") && ! lToken[nTokenOffset+3]["sValue"].startsWith("seul");
    },
    _g_cond_g2_147: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+3], ":[NA].*:[pi]") && g_morph(lToken[nTokenOffset+4], ":[NA].*:s", "*") && ! apposition(lToken[nTokenOffset+3]["sValue"], lToken[nTokenOffset+4]["sValue"]) && ! (g_value(lToken[nLastToken+1], "|et|,|") && g_morph(g_token(lToken, nLastToken+2), ":A")) && ! (lToken[nTokenOffset+1]["sValue"].startsWith("de") && g_value(lToken[nTokenOffset], "|un|une|"));
    },
    _g_cond_g2_148: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_morph(lToken[nTokenOffset], ">(?:et|ou)/|:R") && ! lToken[nTokenOffset+3]["sValue"].startsWith("seul");
    },
    _g_cond_g2_149: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":[NA].*:[pi]", ":V0") && g_morph(lToken[nTokenOffset+3], ":[NA].*:s", "*") && ! apposition(lToken[nTokenOffset+2]["sValue"], lToken[nTokenOffset+3]["sValue"]) && ! (g_value(lToken[nLastToken+1], "|et|,|") && g_morph(g_token(lToken, nLastToken+2), ":A"));
    },
    _g_cond_g2_150: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return (g_morph(lToken[nTokenOffset], ":(?:[VRBX]|Cs|LV)|>comme/|<start>|>,", "*") || g_morph(lToken[nTokenOffset+3], ":N", ":[AQ]")) && ! lToken[nTokenOffset+3]["sValue"].startsWith("seul");
    },
    ...
    _g_cond_g2_152: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_morph(lToken[nTokenOffset+3], ":G|>a/") && checkAgreement(lToken[nTokenOffset+2]["sValue"], lToken[nTokenOffset+3]["sValue"]);
    },
    ...
    _g_cond_g2_153: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return (g_morph(lToken[nTokenOffset+2], ":[NA].*:s", ":[ipGWP]") && ! (g_value(lToken[nLastToken+1], "|et|ou|") && g_morph(g_token(lToken, nLastToken+2), ":[NA]"))) || aREGULARPLURAL.has(lToken[nTokenOffset+2]["sValue"]);
    },
    ...
    _g_cond_g2_155: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":[NA].*:[pi]") && g_morph(lToken[nTokenOffset+3], ":[NA].*:[pi]", ":(?:[123][sp]|G)") && g_morph(lToken[nTokenOffset+4], ":[NA].*:s", "*") && lToken[nTokenOffset+4]["sValue"].gl_isLowerCase() && ! look(sSentence.slice(0,lToken[1+nTokenOffset]["nStart"]), "(?i)\\bune? de +$") && ! lToken[nTokenOffset+4]["sValue"].startsWith("seul");
    },
    _g_cond_g2_156: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":[NA].*:[pi]", "[123][sp]") && g_morph(lToken[nTokenOffset+3], ":[NA].*:[pi]", ":(?:[123][sp]|G)") && g_morph(lToken[nTokenOffset+4], ":[NA].*:s", "*") && ! look(sSentence.slice(0,lToken[1+nTokenOffset]["nStart"]), "(?i)\\bune? de +$") && ! lToken[nTokenOffset+4]["sValue"].startsWith("seul");
    },
    ...
    _g_cond_g2_158: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ( g_morph(lToken[nTokenOffset+2], ":[NA].*:s", ":(?:[ipGWP]|V0)") && ! (g_value(lToken[nLastToken+1], "|et|ou|") && g_morph(g_token(lToken, nLastToken+2), ":[NA]")) ) || aREGULARPLURAL.has(lToken[nTokenOffset+1]["sValue"]);
    },
    ...
    _g_cond_g2_186: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_morph(lToken[nTokenOffset], ":[NA]|>(?:et|ou)/") && ! lToken[nTokenOffset+3]["sValue"].startsWith("seul");
    },
    ...
    _g_cond_g2_187: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+3], ":[NA].*:[pi]", ":G") && g_morph(lToken[nTokenOffset+4], ":[NA].*:s", "*") && ! apposition(lToken[nTokenOffset+3]["sValue"], lToken[nTokenOffset+4]["sValue"]) && ! (g_value(lToken[nLastToken+1], "|et|,|") && g_morph(g_token(lToken, nLastToken+2), ":A")) && ! (lToken[nTokenOffset+1]["sValue"].startsWith("de") && g_value(lToken[nTokenOffset], "|un|une|"));
    },
    ...
    _g_cond_g2_193: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nTokenOffset+1], "|neuf|mille|") && ( (g_morph(lToken[nTokenOffset+2], ":[NA].*:s", "*") && ! g_value(lToken[nTokenOffset+2], "|maximum|minimum|multiplié|divisé|janvier|février|mars|avril|mai|juin|juillet|août|aout|septembre|octobre|novembre|décembre|rue|route|ruelle|place|boulevard|avenue|allée|chemin|sentier|square|impasse|cour|quai|chaussée|côte|vendémiaire|brumaire|frimaire|nivôse|pluviôse|ventôse|germinal|floréal|prairial|messidor|thermidor|fructidor|") ) || aREGULARPLURAL.has(lToken[nTokenOffset+2]["sValue"])) && ! re.search("^[IVXLDM]+$", lToken[nTokenOffset+1]["sValue"]);
    },
    _g_cond_g2_194: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ( g_morph(lToken[nTokenOffset+2], ":[NA].*:s", "*") && ! g_morph(lToken[nTokenOffset], ":N.*:m:[is]") && ! g_value(lToken[nTokenOffset+2], "|maximum|minimum|multiplié|divisé|janvier|février|mars|avril|mai|juin|juillet|août|aout|septembre|octobre|novembre|décembre|rue|route|ruelle|place|boulevard|avenue|allée|chemin|sentier|square|impasse|cour|quai|chaussée|côte|vendémiaire|brumaire|frimaire|nivôse|pluviôse|ventôse|germinal|floréal|prairial|messidor|thermidor|fructidor|") ) || aREGULARPLURAL.has(lToken[nTokenOffset+2]["sValue"]);
    },
    _g_cond_g2_195: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nTokenOffset+2], "|maximum|minimum|multiplié|divisé|") && (g_morph(lToken[nTokenOffset+2], ":[NA].*:s", "*") || aREGULARPLURAL.has(lToken[nTokenOffset+1]["sValue"])) && ! g_value(lToken[nTokenOffset], "|le|un|ce|du|");
    },
    ...
    _g_cond_g2_220: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nLastToken-1+1], ":[NA].*:s", ":(?:G|P|[me]:[ip]|V0|3[sp])") && g_morph(lToken[nLastToken-2+1], ":[NA].*:[pi]") && ! apposition(lToken[nLastToken-2+1]["sValue"], lToken[nLastToken-1+1]["sValue"]);
    },
    ...
    _g_cond_g2_246: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return (g_morph(lToken[nTokenOffset+3], ":[NA].*:s", ":[ip]|>o(?:nde|xydation|r)/") && g_morph(lToken[nTokenOffset], ":(?:G|[123][sp])|<start>", ":[AD]")) || aREGULARPLURAL.has(lToken[nTokenOffset+3]["sValue"]);
    },
    _g_cond_g2_247: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+4], ":[NA].*:s", ":[ip]|>fraude/") || aREGULARPLURAL.has(lToken[nTokenOffset+4]["sValue"]);
    },
    ...
    _g_cond_g2_256: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return lToken[nTokenOffset+2]["sValue"] != "clair" && lToken[nTokenOffset+2]["sValue"] != "Claire";
    },
    ...
    _g_cond_g2_271: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_morph(lToken[nTokenOffset+1], ":N") && (g_analyse(lToken[nLastToken-1+1], ":V1.*:Q", ":(?:M|Oo)") || g_analyse(lToken[nLastToken-1+1], ":[123][sp]", ":[MNG]"));
    },
    ...
    _g_cond_g2_278: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nLastToken-1+1], ":V", ":M") && ! (g_morph(lToken[nTokenOffset+1], ":N") && g_morph(lToken[nTokenOffset], ":D")) && ! (g_value(lToken[nTokenOffset+1], "|devant|") && g_morph(lToken[nLastToken-1+1], ":N"));
    },
    _g_cond_g2_279: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nLastToken-1+1], ":V", ":M") && ! (g_morph(lToken[nTokenOffset+1], ":N") && g_morph(lToken[nTokenOffset], ":D")) && ! (g_value(lToken[nTokenOffset+1], "|devant|") && g_morph(lToken[nLastToken-1+1], ":N")) && ! g_tag_before(lToken[nTokenOffset+1], dTags, "_ceque_");
    },
    ...
    _g_cond_g2_281: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nTokenOffset+1], "|puis|") && g_morph(lToken[nLastToken-1+1], ":V", ":M") && ! (g_morph(lToken[nTokenOffset+1], ":N") && g_morph(lToken[nTokenOffset], ":D"));
    },
    _g_cond_g2_282: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nTokenOffset+1], "|puis|") && g_morph(lToken[nLastToken-1+1], ":V", ":M") && ! (g_morph(lToken[nTokenOffset+1], ":N") && g_morph(lToken[nTokenOffset], ":D")) && ! g_tag_before(lToken[nTokenOffset+1], dTags, "_ceque_");
    },
    _g_cond_g2_283: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nTokenOffset], "|me|m’|te|t’|se|s’|nous|vous|le|la|l’|les|") && g_morph(lToken[nLastToken-1+1], ":V", ":M") && ! (g_morph(lToken[nTokenOffset+1], ":N") && g_morph(lToken[nTokenOffset], ":D"));
    },
    _g_cond_g2_284: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nLastToken-1+1], ":V", ":M") && ! (g_morph(lToken[nTokenOffset+1], ":N") && g_morph(lToken[nTokenOffset], ":D"));
    },
    _g_cond_g2_285: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nLastToken-1+1], ":V", ":M") && ! (g_morph(lToken[nTokenOffset+1], ":N") && g_morph(lToken[nTokenOffset], ":D")) && ! g_tag_before(lToken[nTokenOffset+1], dTags, "_ceque_");
    },
    _g_cond_g2_286: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nLastToken-1+1], ":V", ":[MN]") && ! (g_morph(lToken[nTokenOffset+1], ":N") && g_morph(lToken[nTokenOffset], ":D"));
    },
    ...
    _g_cond_g2_289: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+3], ":V", ":[NGMY]") && ! lToken[nTokenOffset+3]["sValue"].slice(0,1).gl_isUpperCase();
    },
    ...
    _g_cond_g2_306: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+1], ":", ":[GN]") && g_morph(lToken[nLastToken-1+1], ":V", ":M|>(?:accompagner|armer|armurer|casquer|déguiser)/") && ! g_value(lToken[nLastToken+1], "|par|");
    },
    ...
    _g_cond_gv1_24: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_tag(lToken[nTokenOffset+1], "_enum_") && g_morph(lToken[nTokenOffset+2], ":3s") && ! g_morph(lToken[nTokenOffset], ":[RV]|>(?:et|ou)/") && ! (g_tag(lToken[nTokenOffset], "_ceque_") && g_morph(lToken[nLastToken-1+1], ":3s"));
    },
    _g_cond_gv1_25: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_tag(lToken[nTokenOffset+1], "_enum_") && g_morph(lToken[nTokenOffset+3], ":3s") && ! g_morph(lToken[nTokenOffset], ":[RV]|>(?:et|ou)/") && ! (g_tag(lToken[nTokenOffset], "_ceque_") && g_morph(lToken[nLastToken-1+1], ":3s"));
    },
    _g_cond_gv1_26: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_tag(lToken[nTokenOffset+1], "_enum_") && g_morph(lToken[nTokenOffset+4], ":3s") && ! g_morph(lToken[nTokenOffset], ":[RV]|>(?:et|ou)/") && ! (g_tag(lToken[nTokenOffset], "_ceque_") && g_morph(lToken[nLastToken-1+1], ":3s"));
    },
    _g_cond_gv1_27: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_tag(lToken[nTokenOffset+2], "_enum_");
    },
    ...
    _g_cond_gv1_34: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nLastToken-1+1], "|légion|néant|réalité|") && ! g_morph(lToken[nTokenOffset], ":[RV]|>(?:ne|nous)/") && g_morph(lToken[nTokenOffset+2], ":1p") && ! (g_tag(lToken[nTokenOffset], "_ceque_") && g_morph(lToken[nLastToken-1+1], ":3s"));
    },
    ...
    _g_cond_gv1_35: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nLastToken-1+1], "|légion|néant|réalité|") && ! g_morph(lToken[nTokenOffset], ":[RV]|>(?:ne|nous)/") && g_morph(lToken[nTokenOffset+3], ":1p") && ! (g_tag(lToken[nTokenOffset], "_ceque_") && g_morph(lToken[nLastToken-1+1], ":3s"));
    },
    _g_cond_gv1_36: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nLastToken-1+1], "|légion|néant|réalité|") && ! g_morph(lToken[nTokenOffset], ":[RV]|>(?:ne|nous)/") && g_morph(lToken[nTokenOffset+4], ":1p") && ! (g_tag(lToken[nTokenOffset], "_ceque_") && g_morph(lToken[nLastToken-1+1], ":3s"));
    },
    ...
    _g_cond_gv1_65: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nLastToken-1+1], "|légion|néant|réalité|") && g_morph(lToken[nTokenOffset+3], ":[NA].*:[me]", ":[GWf]") && g_morph(lToken[nLastToken-1+1], ":A.*:f", ":[GWMme]") && (g_morph(lToken[nTokenOffset+4], ":[123]s") || (! g_tag(lToken[nTokenOffset+3], "_enum_") && g_morph(lToken[nTokenOffset+4], ":P")));
    },
    ...
    _g_cond_gv1_66: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nLastToken-1+1], "|légion|néant|réalité|") && g_morph(lToken[nTokenOffset+3], ":[NA].*:[me]", ":[GWf]") && g_morph(lToken[nLastToken-1+1], ":A.*:f", ":[GWMme]") && (g_morph(lToken[nTokenOffset+5], ":[123]s") || (! g_tag(lToken[nTokenOffset+3], "_enum_") && g_morph(lToken[nTokenOffset+5], ":P")));
    },
    _g_cond_gv1_67: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nLastToken-1+1], "|légion|néant|réalité|") && g_morph(lToken[nTokenOffset+3], ":[NA].*:[me]", ":[GWf]") && g_morph(lToken[nLastToken-1+1], ":A.*:f", ":[GWMme]") && (g_morph(lToken[nTokenOffset+6], ":[123]s") || (! g_tag(lToken[nTokenOffset+3], "_enum_") && g_morph(lToken[nTokenOffset+6], ":P")));
    },
    _g_cond_gv1_68: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nLastToken-1+1], "|légion|néant|réalité|") && g_morph(lToken[nTokenOffset+3], ":[NA].*:[fe]", ":[GWm]") && g_morph(lToken[nLastToken-1+1], ":A.*:m", ":[GWMfe]") && (g_morph(lToken[nTokenOffset+4], ":[123]s") || (! g_tag(lToken[nTokenOffset+3], "_enum_") && g_morph(lToken[nTokenOffset+4], ":P")));
    },
    _g_cond_gv1_69: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nLastToken-1+1], "|légion|néant|réalité|") && g_morph(lToken[nTokenOffset+3], ":[NA].*:[fe]", ":[GWm]") && g_morph(lToken[nLastToken-1+1], ":A.*:m", ":[GWMfe]") && (g_morph(lToken[nTokenOffset+5], ":[123]s") || (! g_tag(lToken[nTokenOffset+3], "_enum_") && g_morph(lToken[nTokenOffset+5], ":P")));
    },
    _g_cond_gv1_70: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nLastToken-1+1], "|légion|néant|réalité|") && g_morph(lToken[nTokenOffset+3], ":[NA].*:[fe]", ":[GWm]") && g_morph(lToken[nLastToken-1+1], ":A.*:m", ":[GWMfe]") && (g_morph(lToken[nTokenOffset+6], ":[123]s") || (! g_tag(lToken[nTokenOffset+3], "_enum_") && g_morph(lToken[nTokenOffset+6], ":P")));
    },
    _g_cond_gv1_71: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nLastToken-1+1], "|légion|néant|réalité|") && ((g_morph(lToken[nTokenOffset+3], ":[NA].*:f", ":[GWme]") && g_morph(lToken[nLastToken-1+1], ":A.*:m", ":[GWMfe]")) || (g_morph(lToken[nTokenOffset+3], ":[NA].*:m", ":[GWfe]") && g_morph(lToken[nLastToken-1+1], ":A.*:f", ":[GWme]"))) && (g_morph(lToken[nTokenOffset+4], ":[123]s") || (! g_tag(lToken[nTokenOffset+3], "_enum_") && g_morph(lToken[nTokenOffset+4], ":P")));
    },
    _g_cond_gv1_72: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nLastToken-1+1], "|légion|néant|réalité|") && ((g_morph(lToken[nTokenOffset+3], ":[NA].*:f", ":[GWme]") && g_morph(lToken[nLastToken-1+1], ":A.*:m", ":[GWMfe]")) || (g_morph(lToken[nTokenOffset+3], ":[NA].*:m", ":[GWfe]") && g_morph(lToken[nLastToken-1+1], ":A.*:f", ":[GWme]"))) && (g_morph(lToken[nTokenOffset+5], ":[123]s") || (! g_tag(lToken[nTokenOffset+3], "_enum_") && g_morph(lToken[nTokenOffset+5], ":P")));
    },
    _g_cond_gv1_73: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nLastToken-1+1], "|légion|néant|réalité|") && ((g_morph(lToken[nTokenOffset+3], ":[NA].*:f", ":[GWme]") && g_morph(lToken[nLastToken-1+1], ":A.*:m", ":[GWMfe]")) || (g_morph(lToken[nTokenOffset+3], ":[NA].*:m", ":[GWfe]") && g_morph(lToken[nLastToken-1+1], ":A.*:f", ":[GWme]"))) && (g_morph(lToken[nTokenOffset+6], ":[123]s") || (! g_tag(lToken[nTokenOffset+3], "_enum_") && g_morph(lToken[nTokenOffset+6], ":P")));
    },
    _g_cond_gv1_74: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nLastToken-1+1], "|légion|néant|réalité|") && ((g_morph(lToken[nTokenOffset+3], ":[NA].*:f", ":[GWme]") && g_morph(lToken[nLastToken-1+1], ":A.*:m", ":[GWMfe]")) || (g_morph(lToken[nTokenOffset+3], ":[NA].*:m", ":[GWfe]") && g_morph(lToken[nLastToken-1+1], ":A.*:f", ":[GWme]"))) && g_morph(lToken[nTokenOffset+4], ":(?:[123]p|P)");
    },
    _g_cond_gv1_75: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nLastToken-1+1], "|légion|néant|réalité|") && ((g_morph(lToken[nTokenOffset+3], ":[NA].*:f", ":[GWme]") && g_morph(lToken[nLastToken-1+1], ":A.*:m", ":[GWMfe]")) || (g_morph(lToken[nTokenOffset+3], ":[NA].*:m", ":[GWfe]") && g_morph(lToken[nLastToken-1+1], ":A.*:f", ":[GWme]"))) && g_morph(lToken[nTokenOffset+5], ":(?:[123]p|P)");
    },
    _g_cond_gv1_76: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nLastToken-1+1], "|légion|néant|réalité|") && ((g_morph(lToken[nTokenOffset+3], ":[NA].*:f", ":[GWme]") && g_morph(lToken[nLastToken-1+1], ":A.*:m", ":[GWMfe]")) || (g_morph(lToken[nTokenOffset+3], ":[NA].*:m", ":[GWfe]") && g_morph(lToken[nLastToken-1+1], ":A.*:f", ":[GWme]"))) && g_morph(lToken[nTokenOffset+6], ":(?:[123]p|P)");
    },
    ...
    _g_cond_gv1_79: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_tag(lToken[nTokenOffset+2], "_enum_") && ((g_morph(lToken[nTokenOffset+2], ":M.*:f", ":[GWme]") && g_morph(lToken[nLastToken-1+1], ":A.*:m", ":[GWfe]")) || (g_morph(lToken[nTokenOffset+2], ":M.*:m", ":[GWfe]") && g_morph(lToken[nLastToken-1+1], ":A.*:f", ":[GWme]"))) && (g_morph(lToken[nTokenOffset+3], ":[123]s") || (! g_tag(lToken[nTokenOffset+2], "_enum_") && g_morph(lToken[nTokenOffset+3], ":P")));
    },
    _g_cond_gv1_80: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_tag(lToken[nTokenOffset+2], "_enum_") && ((g_morph(lToken[nTokenOffset+2], ":M.*:f", ":[GWme]") && g_morph(lToken[nLastToken-1+1], ":A.*:m", ":[GWfe]")) || (g_morph(lToken[nTokenOffset+2], ":M.*:m", ":[GWfe]") && g_morph(lToken[nLastToken-1+1], ":A.*:f", ":[GWme]"))) && (g_morph(lToken[nTokenOffset+4], ":[123]s") || (! g_tag(lToken[nTokenOffset+2], "_enum_") && g_morph(lToken[nTokenOffset+4], ":P")));
    },
    _g_cond_gv1_81: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_tag(lToken[nTokenOffset+2], "_enum_") && ((g_morph(lToken[nTokenOffset+2], ":M.*:f", ":[GWme]") && g_morph(lToken[nLastToken-1+1], ":A.*:m", ":[GWfe]")) || (g_morph(lToken[nTokenOffset+2], ":M.*:m", ":[GWfe]") && g_morph(lToken[nLastToken-1+1], ":A.*:f", ":[GWme]"))) && (g_morph(lToken[nTokenOffset+5], ":[123]s") || (! g_tag(lToken[nTokenOffset+2], "_enum_") && g_morph(lToken[nTokenOffset+5], ":P")));
    },
    ...
    _g_cond_gv1_83: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":A.*:[fp]", ":(?:G|:m:[si])") && g_morph(lToken[nTokenOffset+3], ":[123]s");
    },
    ...
    _g_cond_gv1_84: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":A.*:[mp]", ":(?:G|:f:[si])") && g_morph(lToken[nTokenOffset+3], ":[123]s");
    },
    ...
    _g_cond_gv1_85: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":A.*:[fs]", ":(?:G|:m:[pi])") && g_morph(lToken[nTokenOffset+3], ":[123]p");
    },
    ...
    _g_cond_gv1_86: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":A.*:[ms]", ":(?:G|:f:[pi])") && g_morph(lToken[nTokenOffset+3], ":[123]p");
    },
    ...
    _g_cond_gv1_87: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":A.*:m", ":[fe]") && g_morph(lToken[nLastToken-1+1], ":[NA]:f", ":[me]");
    },
    _g_cond_gv1_88: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! bCondMemo && g_morph(lToken[nTokenOffset+2], ":A.*:f", ":[me]") && g_morph(lToken[nLastToken-1+1], ":[NA]:m", ":[fe]");
    },
    _g_cond_gv1_89: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":A.*:p", ":[Gsi]") && g_morph(lToken[nTokenOffset+3], ":[123]s");
    },
    ...
    _g_cond_gv1_90: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! bCondMemo && g_morph(lToken[nTokenOffset+2], ":A.*:s", ":[Gpi]") && g_morph(lToken[nTokenOffset+3], ":[123]p");
    },
    ...
    _g_cond_gv1_151: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nTokenOffset+2], "|bref|désolé|désolée|pire|")  && ! g_tag(lToken[nTokenOffset+2], "_exctx_") && g_morph(lToken[nTokenOffset+2], ":A.*:[fp]", ":(?:G|E|M1|W|P|m:[si])") && ! look(sSentence.slice(lToken[nLastToken]["nEnd"]), "^ +(?:y (?:a|aura|avait|eut)|d(?:ut|oit|evait|evra) y avoir|s’agi(?:ssait|t|ra))[, .]");
    },
    ...
    _g_cond_gv1_165: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nLastToken+1], "|il|elle|on|ils|elles|iel|iels|") && ! (g_value(lToken[nLastToken-1+1], "|vient|dit|surgit|survient|provient|") && g_morph(lToken[nLastToken+1], ":(?:[MD]|Oo)|>[A-Z]/")) && g_morph(lToken[nLastToken-1+1], ":V[23].*:Ip.*:3s", ":G|>(?:devoir|suffire|para[îi]tre)/") && analyse(lToken[nLastToken-1+1]["sValue"].slice(0,-1)+"s", ":E:2s");
    },
    ...
    _g_cond_gv1_166: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nLastToken+1], "|il|elle|on|ils|elles|iel|iels|") && ! (g_value(lToken[nLastToken-1+1], "|vient|dit|surgit|survient|provient|") && g_morph(lToken[nLastToken+1], ":(?:[MD]|Oo)|>[A-Z]/")) && g_morph(lToken[nLastToken-1+1], ":V[23].*:Ip.*:3s", ":[GNA]|>(?:devoir|suffire|para[îi]tre)/") && analyse(lToken[nLastToken-1+1]["sValue"].slice(0,-1)+"s", ":E:2s");
    },
    ...
    _g_cond_gv1_179: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_space_between_tokens(lToken[nTokenOffset+1], lToken[nTokenOffset+1+1], 1, 1) && g_morph(lToken[nTokenOffset+1], ":E", ":[GM]|>(?:aller|partir)/") && g_morph(lToken[nLastToken+1], ":|<end>|>,", ":(?:N|A|Q|Y|M|P|H|T|D|Ov)|>(?:pour|plus|moins|mieux|peu|plupart|trop|très|une?)/") && g_morph(lToken[nTokenOffset], ":Cc|<start>|>,");
    },
    _g_cond_gv1_180: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_space_between_tokens(lToken[nTokenOffset+2], lToken[nTokenOffset+2+1], 1, 1) && g_morph(lToken[nTokenOffset+2], ":V(?:1.*:Ip.*:2s|[23].*:Ip.*:3s)", ":[GM]|>(?:aller|partir)/") && g_morph(lToken[nLastToken+1], ":|<end>|>,", ":(?:N|A|Y|M|P|B|3[sp]|D|Ov)|>(?:pour|plus|moins|mieux|peu|trop|très|en|y)/");
    },
    ...
    _g_cond_gv1_199: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_tag(lToken[nTokenOffset+2], "_upron_") && g_morph(lToken[nTokenOffset+1], ":V", ":Q|>soit/") && (g_morph(lToken[nTokenOffset+2], ":Y", ":[NAQ]") || aSHOULDBEVERB.has(lToken[nTokenOffset+2]["sValue"])) && ! g_morph(lToken[nTokenOffset], ":Y|>ce/") && ! g_value(lToken[nTokenOffset], "|c’|") && ! g_value(g_token(lToken, nTokenOffset+1-2), "|ce|") && ! g_tag_before(lToken[nTokenOffset+1], dTags, "_ceque_") && ! g_tag_before(lToken[nTokenOffset+1], dTags, "_sujinfi_");
    },
    ...
    _g_cond_gv2_49: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_tag(lToken[nTokenOffset+2], "_enum_") && g_morph(lToken[nTokenOffset], ":C|<start>|>,", ":[YP]") && g_morph(lToken[nTokenOffset+2], ":[NA].*:[si]", ":G") && ! ( (g_value(lToken[nTokenOffset+2], "|dizaine|douzaine|quinzaine|vingtaine|trentaine|quarantaine|cinquantaine|soixantaine|centaine|majorité|minorité|millier|partie|poignée|tas|paquet|moitié|") || g_tag_before(lToken[nTokenOffset+1], dTags, "_ni_") || g_value(lToken[nTokenOffset], "|et|ou|")) && g_morph(lToken[nTokenOffset+3], ":3?p") );
    },
    _g_cond_gv2_50: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! checkAgreement(lToken[nTokenOffset+2]["sValue"], lToken[nTokenOffset+3]["sValue"]);
    },
    _g_cond_gv2_51: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! bCondMemo && isVeryAmbiguousAndWrong(lToken[nTokenOffset+2]["sValue"], lToken[nTokenOffset+3]["sValue"], ":s", ":3s", g_value(lToken[nTokenOffset], "|<start>|,|"));
    },
    ...
    _g_cond_gv2_63: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_tag(lToken[nTokenOffset+1], "bcp_plur") && ! g_morph(lToken[nTokenOffset+2], ":3p");
    },
    _g_cond_gv2_64: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! bCondMemo && g_tag(lToken[nTokenOffset+1], "bcp_sing") && ! g_morph(lToken[nTokenOffset+2], ":3s");
    },
    _g_cond_gv2_65: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! bCondMemo && lToken[nTokenOffset+2]["sValue"] != "a" && ! g_tag(lToken[nTokenOffset+1], "bcp_sing") && ! g_morph(lToken[nTokenOffset+2], ":3p") && ! (g_space_between_tokens(lToken[nTokenOffset+1], lToken[nTokenOffset+1+1], 1, 2) && g_morph(lToken[nTokenOffset+2], ":V0"));
    },
    ...
    _g_cond_gv2_69: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! bCondMemo && isAmbiguousAndWrong(lToken[nTokenOffset+2]["sValue"], lToken[nTokenOffset+3]["sValue"], ":p", ":3p");
    },
    ...
    _g_cond_gv2_71: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! bCondMemo && isVeryAmbiguousAndWrong(lToken[nTokenOffset+2]["sValue"], lToken[nTokenOffset+3]["sValue"], ":p", ":3p", g_value(lToken[nTokenOffset], "|<start>|,|"));
    },
    _g_cond_gv2_72: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! bCondMemo && isVeryAmbiguousAndWrong(lToken[nTokenOffset+2]["sValue"], lToken[nTokenOffset+3]["sValue"], ":m:p", ":3p", g_value(lToken[nTokenOffset], "|<start>|,|"));
    },
    ...
    _g_cond_gv2_73: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! bCondMemo && isVeryAmbiguousAndWrong(lToken[nTokenOffset+2]["sValue"], lToken[nTokenOffset+3]["sValue"], ":f:p", ":3p", g_value(lToken[nTokenOffset], "|<start>|,|"));
    },
    ...
    _g_cond_gv2_74: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset], ":Cs|<start>|>,") && !( g_morph(lToken[nTokenOffset+3], ":3s") && look(sSentence.slice(0,lToken[1+nTokenOffset]["nStart"]), "(?i)\\b(?:l[ea] |l’|une? |ce(?:tte|t|) |[mts](?:on|a) |[nv]otre ).+ entre .+ et ") ) && ! checkAgreement(lToken[nTokenOffset+2]["sValue"], lToken[nTokenOffset+3]["sValue"]);
    },
    ...
    _g_cond_gv2_77: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! bCondMemo && ! checkAgreement(lToken[nTokenOffset+3]["sValue"], lToken[nTokenOffset+4]["sValue"]);
    },
    ...
    _g_cond_gv2_81: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nTokenOffset+4], "|plupart|majorité|groupe|") && ! g_tag(lToken[nTokenOffset+4], "_enum_") && ! (g_value(lToken[nLastToken+1], "|et|ou|") && g_morph(g_token(lToken, nLastToken+2), ":D")) && ! (g_value(g_token(lToken, nLastToken+2), "|et|ou|") && g_morph(g_token(lToken, nLastToken+3), ":D"));
    },
    _g_cond_gv2_82: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nTokenOffset+4], "|plupart|majorité|groupe|") && ! g_tag(lToken[nTokenOffset+4], "_enum_") && ! (g_value(lToken[nLastToken+1], "|et|ou|") && g_morph(g_token(lToken, nLastToken+2), ":D")) && ! (g_value(g_token(lToken, nLastToken+2), "|et|ou|") && g_morph(g_token(lToken, nLastToken+3), ":D")) && ! (g_morph(lToken[nTokenOffset+4], ":Y") && g_morph(lToken[nTokenOffset+2], ">(?:pouvoir|vouloir|devoir)"));
    },
    _g_cond_gv2_83: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nTokenOffset+4], "|plupart|majorité|groupe|") && ! g_tag(lToken[nTokenOffset+4], "_enum_") && ! (g_value(lToken[nLastToken+1], "|et|ou|") && g_morph(g_token(lToken, nLastToken+2), ":D")) && ! (g_value(g_token(lToken, nLastToken+2), "|et|ou|") && g_morph(g_token(lToken, nLastToken+3), ":D")) && ! g_morph(lToken[nTokenOffset], ":[NA]");
    },
    _g_cond_gv2_84: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_value(lToken[nTokenOffset+4], "|plupart|majorité|groupe|") && ! g_tag(lToken[nTokenOffset+4], "_enum_") && ! (g_value(lToken[nLastToken+1], "|et|ou|") && g_morph(g_token(lToken, nLastToken+2), ":D")) && ! (g_value(g_token(lToken, nLastToken+2), "|et|ou|") && g_morph(g_token(lToken, nLastToken+3), ":D")) && ! (g_morph(lToken[nTokenOffset+4], ":Y") && g_morph(lToken[nTokenOffset+2], ">(?:pouvoir|vouloir|devoir)")) && ! g_morph(lToken[nTokenOffset], ":[NA]");
    },
    _g_cond_gv2_85: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset], ":R") && ! g_value(lToken[nTokenOffset+4], "|plupart|majorité|groupe|") && ! (g_value(lToken[nLastToken+1], "|et|ou|") && g_morph(g_token(lToken, nLastToken+2), ":D"));
    },
    _g_cond_gv2_86: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_morph(lToken[nTokenOffset], ":[NA]");
    },
