...
atGwuEncryptIfPossible = {
   ...
   log: function(msg) {
    ...
    setSign: function() {
      ...
      if (!gMsgCompose.compFields.composeSecure.signMessage) {
    ...
    setEncrypt: function (enable) {
      ...
      let encryptOn = gMsgCompose.compFields.composeSecure.requireEncryptMessage;
      let doEncrypt = true;
      ...
      // do sign also when encrypt alredy set
      } else if (enable && encryptOn && this.auto_sign) {
        this.setSign()
...
// C:\Users\gwu\AppData\Roaming\Thunderbird\Profiles\7mj4411z.dev\extensions
// "C:\Program Files (x86)\Mozilla Thunderbird 68\thunderbird.exe" -no-remote -P dev -purgecaches
// package app: 
...
//   /cygdrive/c/Program\ Files\ \(x86\)/Mozilla\ Thunderbird\ 68/thunderbird.exe -no-remote -P dev -purgecaches    
//
// debug
//  FF remote debug: http://kewisch.wordpress.com/2013/06/13/the-thunderbird-remote-debugger-is-alive/
// key
//  https://fam.tuwien.ac.at/~schamane/_/oldblog/140216_openssl_self-signed_certificates_thunderbird.html