  ...
  checkMailForHtmlpart: function() {
    ...
    try {
      if (gFolderDisplay.selectedCount != 1) {
        ...
        let ahtMsgIsJunk = (ahtMsgJunkScore == Components.interfaces
        ...
        if ((ahtMsgIsJunk) || (gFolderDisplay.selectedMessageIsFeed)) {
          ...
          MsgHdrToMimeMessage(ahtMsgHdr, null, function(aMsgHdr, aMimeMsg) {
            ...
            if (aMimeMsg.prettyString().search("multipart/encrypted") !=
              -1) {
              ...
              MsgHdrToMimeMessage(ahtMsgHdr, null, function(aMsgHdr,
                aMimeMsg) {
                ...
                if (aMimeMsg.prettyString().search(
                    "Body: text/html") != -1) {
