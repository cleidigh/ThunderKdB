...
var profileLauncher = {
	...
	setProfileIcon : function() {
		var icon = "chrome://profilelauncher/skin/icons/button"+profileLauncher.prefs.getIntPref("extensions.profileswitcher.icon_color")+".png";
		var icon2 = "chrome://profilelauncher/skin/icons/user"+profileLauncher.prefs.getIntPref("extensions.profileswitcher.icon_color")+".png";
	...
	setABLabel : function() {
		...
		var icon = "chrome://profilelauncher/skin/icons/user"+profileLauncher.prefs.getIntPref("extensions.profileswitcher.icon_color")+".png";
