...
var CheckDomainPref = {
	...
	load: function() {
		...
		exclude.value = decodeURIComponent(escape(preferencesService.getCharPref("extensions.checkdomain.exclude")));
	},
	
	save: function() {
		var preferencesService = Components.classes["@mozilla.org/preferences-service;1"].getService(Components.interfaces.nsIPrefBranch);
		var exclude = document.getElementById("exclude");
		preferencesService.setCharPref("extensions.checkdomain.exclude", unescape(encodeURIComponent(exclude.value)));
	}
