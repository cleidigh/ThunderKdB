if ("undefined" == typeof(cardbookPreferences)) {
	...
	var cardbookPreferences = {
		...
		insertIMPPsSeed: function () {
			this.setIMPPs(0,"skype:" + cardbookRepository.strBundle.GetStringFromName("impp.skype") + ":skype");
			this.setIMPPs(1,"jabber:" + cardbookRepository.strBundle.GetStringFromName("impp.jabber") + ":xmpp");
			this.setIMPPs(2,"googletalk:" + cardbookRepository.strBundle.GetStringFromName("impp.googletalk") + ":gtalk");
			this.setIMPPs(3,"qq:" + cardbookRepository.strBundle.GetStringFromName("impp.qq") + ":qq");
		},
		...
		getPrefValueLabel: function () {
			...
			if (prefValueLabel) {
				...
				return cardbookRepository.strBundle.GetStringFromName("prefValueLabel");
			}
		},
