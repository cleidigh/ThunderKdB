...
"use strict"; // Called from the outer wrapper JS code.
...
pdfjsLib.GlobalWorkerOptions.workerSrc = "chrome://conversations/content/vendor/pdf.worker.js";
let viewer;
...
function init({
  ...
  let offset = 0; // So [Iterator] doesn't seem to like too much the fact that [chunks] has
