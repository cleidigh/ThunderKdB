...
var PluginHelpers = {
  ...
  alternativeSender(aRawReps) {
    const aMimeMsg = aRawReps.mime; // This header is a bare email address
  ...
  bugzilla(aRawReps) {
    ...
    if (aMimeMsg.has("x-bugzilla-who")) {
      const keys = ["url", "classification", "product", "component", "keywords", "severity", "status", "priority", "assigned-to", "target-milestone", "changed-fields"];
      const o = {};
