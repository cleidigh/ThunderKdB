...
export function ChoiceOption({
  ...
  return React.createElement(React.Fragment, null, React.createElement("div", null, React.createElement("label", {
    className: "title"
  }, title), React.createElement("br", null), React.createElement("label", null, desc)), React.createElement("div", null, choices.map((choice, i) => React.createElement("span", {
    key: i
...
export function TextOption({
  ...
  return React.createElement(React.Fragment, null, React.createElement("div", null, React.createElement("label", {
    className: "title"
  }, title), React.createElement("br", null), React.createElement("label", null, desc)), React.createElement("div", null, React.createElement("input", {
    type: "text",
    className: "pref",
    value: value,
    onChange: e => {
...
function _ConversationOptions({
  ...
  return React.createElement(React.Fragment, null, React.createElement("h1", null, localizedName), React.createElement("form", {
    ...
    id: "preferencesGrid"
  }, localizedPrefsInfo.map((Item, i) => React.createElement(Item.component, _extends({}, Item.props, {
    key: i,
