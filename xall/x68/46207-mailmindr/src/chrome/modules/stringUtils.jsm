...
class MailmindrStringUtils {
    ...
    static toRelativeString(dateTimeMS, relativeTo) {
        ...
        if (relative > 0) {
            if (days >= 7 && days % 7 == 0) {
                return MailmindrStringUtils.pluralize(
                    days / 7,
                ...
                let hourString = MailmindrStringUtils.pluralize(
                    hours,
                    'mailmindr.utils.core.relative.hours'
                );
                let minuteString = '';
                if (minutes > 0) {
                    minuteString =
                        ' ' +
                        MailmindrStringUtils.pluralize(
                            minutes,
                            'mailmindr.utils.core.relative.andminutes'
                        );
                }
                ...
                return MailmindrStringUtils.pluralize(
                    minutes,
                    'mailmindr.utils.core.relative.minutes'
                );
            }
            ...
            if (seconds > 0) {
                return MailmindrStringUtils.pluralize(
                    seconds,
                    'mailmindr.utils.core.relative.seconds'
                );
            }
        }
        ...
        if (relative < 0) {
            if (days >= 7 && days % 7 == 0) {
                return MailmindrStringUtils.pluralize(
                    days / 7,
                    'mailmindr.utils.core.relative.past.weeks'
                );
            } else if (days > 0) {
                return MailmindrStringUtils.pluralize(
                    days,
                    'mailmindr.utils.core.relative.past.days'
                );
            } else if (hours > 0) {
                let hourString = MailmindrStringUtils.pluralize(
                    hours,
                    'mailmindr.utils.core.relative.past.hours'
                );
                let minuteString = '';
                if (minutes > 0) {
                    minuteString =
                        ...
                        MailmindrStringUtils.pluralize(
                            minutes,
                            'mailmindr.utils.core.relative.past.andminutes'
                        );
                }
                ...
                return MailmindrStringUtils.pluralize(
                    minutes,
                    'mailmindr.utils.core.relative.past.minutes'
                );
            }
            ...
            if (seconds > 0) {
                return MailmindrStringUtils.pluralize(
                    seconds,
                    'mailmindr.utils.core.relative.past.seconds'
                );
            }
        }
