    ...
    constructor() {
        ...
        var is = (this.is = o =>
            false || {
                ...
                generatorFunction:
                    typeof o === 'function' &&
                    o.constructor.name == 'GeneratorFunction',
                generator:
                    typeof o === 'object' &&
                    o.constructor.name == 'GeneratorFunctionPrototype',
        ...
        this.doJoin$ = function*(
            ...
            if (
                ...
                for (var innerIndex in innerList) {
                    var itemInner = [
                        innerKeySelector((value = innerList[innerIndex])),
                        innerIndex,
                        value
                    ];
                    ...
                    for (var outerIndex in outerList) {
                        if (
                            outerKeySelector(outerList[outerIndex]) ==
                            itemInner[0]
                        ) {
                            print(itemInner[2]);
        ...
        this.doDistinct = function(list) {
            ...
            return self.wireUpObject(
                list.filter((item, index, arr) => arr.indexOf(item) == index)
            );
        };
        ...
        this.doSum = function(list, projection) {
            ...
            for (var x of list) {
                result += is(projection).callable ? projection(x) : x;
            }
        ...
        this.wireUpObject = function(whatObject) {
            ...
            if (!hasProperty(obj, 'aggregate')) {
                Object.defineProperty(obj, 'aggregate', {
                    enumerable: false,
                    configurable: false,
                    writable: false,
                    value: aggregator => self.doAggregate(obj, aggregator)
                });
            }
            if (!hasProperty(obj, 'distinct')) {
                Object.defineProperty(obj, 'distinct', {
                    enumerable: false,
                    configurable: false,
                    writable: false,
                    value: aggregator => self.doDistinct(obj)
                });
            }
            if (!hasProperty(obj, 'where')) {
                Object.defineProperty(obj, 'where', {
                    ...
                    configurable: false,
                    writable: false,
                    value: filter => self.doWhere(obj, filter)
                });
            }
            if (!hasProperty(obj, 'join')) {
                Object.defineProperty(obj, 'join', {
                    enumerable: false,
                    configurable: false,
                    writable: false,
                    value: (
            ...
            if (!hasProperty(obj, 'zip')) {
                Object.defineProperty(obj, 'zip', {
                    enumerable: false,
                    configurable: false,
                    writable: false,
                    value: (second, resultSelector) =>
                        self.doZip(obj, second, resultSelector)
                });
            }
            if (!hasProperty(obj, 'select')) {
                Object.defineProperty(obj, 'select', {
                    ...
                    configurable: false,
                    writable: false,
                    value: projection => self.doSelect(obj, projection)
                });
            }
            if (!hasProperty(obj, 'sum')) {
                Object.defineProperty(obj, 'sum', {
                    ...
                    configurable: false,
                    writable: false,
                    value: projection => self.doSum(obj, projection)
                });
            }
            if (!hasProperty(obj, 'toArray')) {
                Object.defineProperty(obj, 'toArray', {
                    enumerable: false,
                    configurable: false,
                    writable: false,
            ...
            if (!hasProperty(obj, 'take')) {
                Object.defineProperty(obj, 'take', {
                    enumerable: false,
                    configurable: false,
                    writable: false,
                    value: num => self.doTake(obj, num)
                });
            }
            if (!hasProperty(obj, 'takeWhile')) {
                Object.defineProperty(obj, 'takeWhile', {
                    enumerable: false,
                    configurable: false,
                    writable: false,
                    value: condition => self.doTakeWhile(obj, condition)
                });
            }
            if (!hasProperty(obj, 'skip')) {
                Object.defineProperty(obj, 'skip', {
                    ...
                    configurable: false,
                    writable: false,
                    value: num => self.doSkip(obj, num)
                });
            }
            if (!hasProperty(obj, 'skipWhile')) {
                Object.defineProperty(obj, 'skipWhile', {
                    enumerable: false,
                    configurable: false,
                    writable: false,
                    value: condition => self.doSkipWhile(obj, condition)
                });
            }
            ...
            if (!hasProperty(obj, 'sort')) {
                Object.defineProperty(obj, 'sort', {
                    ...
                    configurable: false,
                    writable: false,
                    value: sortFunction => self.doSort(obj, sortFunction)
                });
            }
            //}
