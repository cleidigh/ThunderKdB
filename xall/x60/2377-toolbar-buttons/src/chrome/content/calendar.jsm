...
toolbar_buttons.loadPrefWatcher(document, "network.proxy.autoconfig_url", null, toolbar_buttons.setProxyButtonState);
	...
	CustomizableUI.createWidget({
		...
		onCommand: function(event) {
			toolbar_buttons.toggleToolbar(event, 'calendar-bar');
		},
		onCreated: function(aNode) {
			var document = aNode.ownerDocument;
...
toolbar_buttons.loadToggleToolbar(document, "statusbar-toggle", "addon-bar");
		...
		onBuild: function (document) {
			var window = document.defaultView;
			var toolbarbutton_0 = document.createElement('toolbarbutton');
			toolbarbutton_0.id = 'statusbar-toggle';
			toolbarbutton_0.setAttribute('label', buttonStrings.get('statusbar-toggle.label'));
			toolbarbutton_0.setAttribute('tooltiptext', buttonStrings.get('statusbar-toggle.tooltip'));
			toolbarbutton_0.setAttribute("command", "cmd_showStatusBar");
			toolbarbutton_0.classList.add("toolbarbutton-1");
			toolbarbutton_0.classList.add("chromeclass-toolbar-additional");
			return toolbarbutton_0;
		},
...
var gButtonIds = ["themes", "minimize-window", "toggle-proxy", "tb-edit-menu", "delete-event", "tb-about-about", "redo", "delete-tasks", "tasks-toggle", "preferences", "customize-toolbar", "installaddons", "reload-proxy", "inspecter", "import", "profile-folder", "exit", "pagesetup", "tb-file-menu", "tb-new-event", "about-config", "tb-new-task", "toggle-toolbar", "tb-all-menus", "undo", "about-plugins", "restart-app", "about-application", "tasks-in-view", "tb-tools-menu", "extensions", "statusbar-toggle", "addons", "tb-view-menu"];
