...
function setupButtons() {
	...
	loader.loadSubScript("chrome://toolbar-buttons/content/suite_browser.js", gScope);
		...
		onCommand: function(event) {
			...
			window.openHelp('welcome', 'chrome://communicator/locale/help/suitehelp.rdf');
		}
	});
	...
	CustomizableUI.createWidget({
		...
		onBuild: function (document) {
			...
			toolbarbutton_0.setAttribute("observes", "Communicator:WorkMode");
	...
	CustomizableUI.createWidget({
		...
		onBuild: function (document) {
			...
			toolbarbutton_0.classList.add("toolbarbutton-1");
			toolbarbutton_0.classList.add("chromeclass-toolbar-additional");
			toolbarbutton_0.setAttribute("key", "key_findNext");
			return toolbarbutton_0;
		}
	});
	...
	CustomizableUI.createWidget({
		...
		onCommand: function(event) {
			var window = event.target.ownerDocument.defaultView;
			window.openComposeWindow('', '', 0, null);
		}
	});
	...
	CustomizableUI.createWidget({
		...
		onBuild: function (document) {
			...
			menupopup_1.addEventListener('command', function(event) {
				var window = event.target.ownerDocument.defaultView;
			window.onViewToolbarCommand(event); event.stopPropagation();
			}, false);
	...
	CustomizableUI.createWidget({
		...
		onCommand: function(event) {
			...
			var window = event.target.ownerDocument.defaultView;
			window.SidebarSelectPanel(document.getElementById('urn:sidebar:panel:search'), true, true);
		}
	});
	...
	CustomizableUI.createWidget({
		...
		onClick: function(event) {
			toolbar_buttons.openLinkFromPrefTab('url.seamonkey-ext',event);
		},
		onCommand: function(event) {
			toolbar_buttons.openLinkFromPref('url.seamonkey-ext',event);
		}
	});
	...
	CustomizableUI.createWidget({
		...
		onBuild: function (document) {
			var window = document.defaultView;
			var toolbarbutton_0 = document.createElement('toolbarbutton');
			toolbarbutton_0.id = 'javaScriptConsole';
			toolbarbutton_0.setAttribute('label', buttonStrings.get('javaScriptConsole.label'));
			toolbarbutton_0.setAttribute('tooltiptext', buttonStrings.get('javaScriptConsole.tooltip'));
			toolbarbutton_0.setAttribute("command", "Tasks:ErrorConsole");
			toolbarbutton_0.classList.add("toolbarbutton-1");
			toolbarbutton_0.classList.add("chromeclass-toolbar-additional");
			toolbarbutton_0.setAttribute("key", "key_errorConsole");
			return toolbarbutton_0;
		}
	});
	...
	CustomizableUI.createWidget({
		...
		onBuild: function (document) {
			...
			toolbarbutton_0.setAttribute("command", "cmd_zoomReduce");
			toolbarbutton_0.classList.add("toolbarbutton-1");
			toolbarbutton_0.classList.add("chromeclass-toolbar-additional");
			toolbarbutton_0.setAttribute("key", "key_zoomReduce");
			return toolbarbutton_0;
		}
	});
	...
	CustomizableUI.createWidget({
		...
		onCommand: function(event) {
			toolbar_buttons.cloneSeaTab(event);
		}
	});
	...
	CustomizableUI.createWidget({
		...
		onCommand: function(event) {
			toolbar_buttons.toggleToolbar(event, 'status-bar');
		},
		onCreated: function(aNode) {
			var document = aNode.ownerDocument;
	...
	CustomizableUI.createWidget({
		...
		onCommand: function(event) {
			var aThis = event.target;
			var window = event.target.ownerDocument.defaultView;
			return window.goCustomizeToolbar(aThis.parentNode.toolbox);
		}
	});
	...
	CustomizableUI.createWidget({
		...
		onBuild: function (document) {
			...
			menuitem_7.addEventListener('command', function(event) {
				var window = event.target.ownerDocument.defaultView;
			window.toDataManager('|cookies');
			}, false);
			menupopup_1.appendChild(menuitem_7);
			var menuitem_8 = document.createElement('menuitem');
			menuitem_8.setAttribute('label', buttonStrings.get('tb-delete-cookies.label'));
			...
			menuitem_9.setAttribute('label', buttonStrings.get('tb-delete-session-cookies.label'));
	...
	CustomizableUI.createWidget({
		...
		onCommand: function(event) {
			var window = event.target.ownerDocument.defaultView;
			window.gBrowser.undoCloseTab(0);
		}
	});
	...
	CustomizableUI.createWidget({
		...
		onBuild: function (document) {
			...
			toolbarbutton_0.setAttribute("command", "cmd_printSetup");
			toolbarbutton_0.classList.add("toolbarbutton-1");
			toolbarbutton_0.classList.add("chromeclass-toolbar-additional");
			return toolbarbutton_0;
		}
	...
	CustomizableUI.createWidget({
		...
		onBuild: function (document) {
			var window = document.defaultView;
			var toolbarbutton_0 = document.createElement('toolbarbutton');
			toolbarbutton_0.id = 'bookmark-manager';
			toolbarbutton_0.setAttribute('label', buttonStrings.get('bookmark-manager.label'));
			toolbarbutton_0.setAttribute('tooltiptext', buttonStrings.get('bookmark-manager.tooltip'));
			toolbarbutton_0.setAttribute("command", "Browser:ManageBookmark");
			toolbarbutton_0.classList.add("toolbarbutton-1");
			toolbarbutton_0.classList.add("chromeclass-toolbar-additional");
			toolbarbutton_0.setAttribute("key", "manBookmarkKb");
			return toolbarbutton_0;
		}
	});
	...
	CustomizableUI.createWidget({
		...
		onBuild: function (document) {
			...
			toolbarbutton_0.setAttribute("command", "cmd_zoomEnlarge");
			toolbarbutton_0.classList.add("toolbarbutton-1");
			toolbarbutton_0.classList.add("chromeclass-toolbar-additional");
			toolbarbutton_0.setAttribute("key", "key_zoomEnlarge");
			return toolbarbutton_0;
		}
	});
...
toolbar_buttons.loadPrefWatcher(document, "network.proxy.autoconfig_url", null, toolbar_buttons.setProxyButtonState);
	...
	CustomizableUI.createWidget({
		...
		onClick: function(event) {
			toolbar_buttons.openLinkFromPrefTab('url.seamonkey-theme',event);
		},
		onCommand: function(event) {
			toolbar_buttons.openLinkFromPref('url.seamonkey-theme',event);
		}
	});
	...
	CustomizableUI.createWidget({
		...
		onBuild: function (document) {
			...
			toolbarbutton_0.addEventListener('command', function(event) {
				var window = event.target.ownerDocument.defaultView;
			window.handleURLBarCommand('none', event);
			}, false);
			toolbarbutton_0.classList.add("toolbarbutton-1");
			toolbarbutton_0.classList.add("chromeclass-toolbar-additional");
			toolbarbutton_0.addEventListener('dragover', function(event) {
				var window = event.target.ownerDocument.defaultView;
			window.goButtonObserver.onDragOver(event);
			}, false);
			toolbarbutton_0.addEventListener('dragdrop', function(event) {
				var window = event.target.ownerDocument.defaultView;
			window.goButtonObserver.onDrop(event);
			}, false);
			return toolbarbutton_0;
		}
	});
...
var gButtonIds = ["help", "about-disk-cache", "workoffline", "themes", "tb-print-page", "find-prev", "hide-images", "new-message", "find", "about-plugins", "toolbar-menu", "close-other-tabs", "installaddons", "java-toggle", "select-all", "tb-twitter-button", "restart-app", "about-config", "tb-search-resize", "close-all-tabs", "close-tab", "tb-page-info-media", "websearch", "stop-movies", "firefox-extension", "read-news", "clear-data", "javaScriptConsole", "tb-search-plus", "tb-view-menu", "clear-url", "google", "read-mail", "reduce", "tb-clone-tab", "toggle-proxy", "bookmarks-menu-button1", "bookmarks-menu-button2", "gmail", "tb-toggle-popup-blocker", "preferences", "label-all-blank", "print-preview", "wikipedia", "reload-all-tabs", "exit", "tb-clear-url", "favorite-page", "thunderbird-theme", "bottom-page", "tb-all-menus", "undo", "min-font-size", "image-toggle", "reload-skip-cache", "tb-show-all-history", "tb-clear-cache", "show-frame", "tb-saved-passwords", "stop-dynamic-content", "extensions", "statusbar-toggle", "addons", "bookmark-nopop", "tb-open", "javascript-toggle", "stop-iframe", "redo", "next-tab", "saveas", "delete-button", "tb-clear-search", "snap-back", "stop-all", "tb-toggle-menu-bar", "bookmark", "customize-toolbar", "top-page", "find-again", "tab-list", "stop-flash", "inspecter", "toggle-styles", "translate", "pageinfo", "stop-cookies", "bookmark-tabs", "undo-close-tab", "tb-file-menu", "rename-tab", "paypal", "about-mem-cache", "page-source", "thunderbird-extension", "personal-bookmarks-menu-button", "reset", "previous-tab", "about-application", "tb-history-menu", "ebay", "tb-tools-menu", "tb-search-go-button", "yahoo-button", "change-text-direction", "save-frame", "pagesetup", "hotmail-button", "tb-new-tab", "about-cache", "minimize-window", "tb-edit-menu", "tb-about-about", "bookmark-manager", "up-directory", "clipboard-button", "toggle-bookmark-toolbar", "stop-animation", "enlarge", "reload-proxy", "open-current-frame", "toggle-toolbar", "profile-folder", "full-screen", "tb-search-minus", "use-document-fonts", "tb-check-for-update", "tb-about-blank", "firefox-theme", "link-open", "label-blank", "send-link", "tb-cookie-manager", "use-document-colors", "tb-url-go-button", "dictionary-list"];
