...
var HcSingleton= new (function HcSingleton_class(){
	...
	this.use_AUTHOR_LVL        = true; // setted in BOOTSTRAP !!
    ...
    this.set_main_styleSheets= function( bEnable ){
	    ...
	    thySelf.setStyleSheet_plus( "chrome://hidecaptionplus_fx/skin/level_auFORCED.css", bEnable, { level_AuthFORCED: true } );
    },
	...
	this.setStyleSheet_plus= function(aUrl, aEnable, aProps){
		...
		var LEVEL_SHEET=  aProps.level_Agent? sss.AGENT_SHEET: (aProps.level_Author? (thySelf.use_AUTHOR_LVL? sss.AUTHOR_SHEET: sss.AGENT_SHEET): (aProps.level_AuthFORCED? sss.AUTHOR_SHEET: sss.USER_SHEET));
    ...
    this.setStyleSheet=      function(aUrl, aEnable, aMostPriority){
    	...
    	var LEVEL_SHEET= aMostPriority===undefined || aMostPriority? (thySelf.use_AUTHOR_LVL? sss.AUTHOR_SHEET: sss.AGENT_SHEET): sss.USER_SHEET;
	...
	function  do_strings_locale(xul_doc) {
		try {
			var custTbarBundle= Services.strings.createBundle("chrome://browser/locale/customizableui/customizableWidgets.properties"); // NEW FILE for Fx 60 

			//  elf.setAttrs_smart2( xul_doc, "spring"   , ["label","title"], "[h] "+custTbarBundle.GetStringFromName("toolbarspring.label")   );
			thySelf.setAttrs_smart2( xul_doc, "customizableui-special-spacer"   , ["label","title"], "[h] "+custTbarBundle.GetStringFromName("toolbarspacer.label")   );
			thySelf.setAttrs_smart2( xul_doc, "customizableui-special-separator", ["label","title"], "[h] "+custTbarBundle.GetStringFromName("toolbarseparator.label"));
