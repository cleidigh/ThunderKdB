...
var admintags = 
{
	añadirtag: function (messageheader)
	{
		var tagService = Components.classes["@mozilla.org/messenger/tagservice;1"].getService(Components.interfaces.nsIMsgTagService);
		...
		AñadirTagMsgHdr(mintagname, mintagname+" "+messageheader.getStringProperty("keywords"),messageheader); //Key es el nombre de la etiqueta. Funcion definida en mailWindowOverlay.js linea 815
	}
}

function AñadirTagMsgHdr(key, addKey, msgheader)
{
