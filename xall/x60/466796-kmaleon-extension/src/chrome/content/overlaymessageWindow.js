...
function buscarStringMW(cadena_origen, cadena_buscar) //La cadena origen es la cadena donde se quiere buscar y la cadena_buscar es la cadena que se quiere buscar.
{	
	var i=0;
