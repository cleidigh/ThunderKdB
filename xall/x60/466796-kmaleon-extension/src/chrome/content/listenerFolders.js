...
window.addEventListener("load", function(e) { 
	listenerFolders.añadirListener(); 
}, false);
...
var folderListenerKmaleon = 
{
	...
	{  	
		...
		if (parent.URI == defaultFolderSend2)
		{
			try
			{			
				...
				if(lastMsgSent != contenidoMsg) //Esto se hace pq el zunderbir es un pastelazo y por alguna razón el evento itemAdded de la carpeta Enviados se dispara 2 veces, o no, según le dé.
				{
...
var listenerFolders = 
{
	...
	obtenerStringMensaje: function(urimensaje)
	{
		try
		{
			...
			var MsgService = messenger.messageServiceFromURI(MessageURI);  //Es nsIMessenger
	...
	comprobarTagEjecutarPrograma: function (stringMensaje, headerMensaje)
	{
		...
		if (resultBus != -1 && getIDProgIguales())
		{
			...
			strAux.replace(" ",""); //Quitamos los espacios.
			
			if (strAux.length > 1)
			{
				//Aqui se ejecutara el programa
				///////////////////////////////////////////Primero cargamos las variables///////////////////////////////////////////
				var timeL = new Date();	
				var subjectL = "empty";
				...
				///////////////////////////////////////////Guardamos el email en el temp provisionalmente/////////////////////////////////////////////////////////
				var filename = "emailguardadoautE.eml";
				//Para saber el directorio temporal:
				...
				///////////////////////////////////// Ejecutamos el programa guardado ////////////////////////////////
				...
				var args = [pathemailL, emailL, recipientsL, auxTimeStringL, autorL, subjectL, 3, strAux, "ANEXAREMAIL"]; //El strAux es el códigoAsunto del mensaje.
				process.run(false, args, args.length);
							
				admintags.añadirtag(headerMensaje); //AÑADIDO EL TAG 'EN KMALEON' Y EL COLORCITO VERDE AL NOMBRE DEL MAIL EN LA BANDEJA DE ENVIADOS
			}
		}
	},
