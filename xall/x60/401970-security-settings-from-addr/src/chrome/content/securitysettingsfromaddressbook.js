...
atGwuSecuritySettingsFromAddressbook = {
  ...
  splitAdressList: function(msgToPlain) {
    ...
    return msgToPlainArray.map(String.trim);
  },
  ...
  setSign: function(setOn) {
    ...
    if (!gMsgCompose.compFields.securityInfo.QueryInterface(Components.interfaces.nsIMsgSMIMECompFields).signMessage && setOn) {
    ...
    } else if (gMsgCompose.compFields.securityInfo.QueryInterface(Components.interfaces.nsIMsgSMIMECompFields).signMessage && !setOn) {
  ...
  setEncrypt: function(setOn) {
    ...
    let encryptSet = gMsgCompose.compFields.securityInfo.QueryInterface(Components.interfaces.nsIMsgSMIMECompFields).requireEncryptMessage;
