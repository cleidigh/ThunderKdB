...
var displayName         = "MailSentry"; // The name displayed to the user (don't include the version)
var version             = "1.4.2";
var name                = "mailsentry"; // The leafname of the JAR file (without the .jar part)
...
if(error == SUCCESS)
{
    ...
    for (var i = 0; i < skins.length; i++) {
		var skinBase = "skin/";
		if( skins[i] == "" ) {
			skinBase = "skin";  // extra slash will break it
		}
		registerChrome(skinFlag, folder, skinBase + skins[i] + skinDir);
    }
