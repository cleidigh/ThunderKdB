...
BoxModelViewer.prototype = 
{
  ...
  {
    return aStyle ? aStyle.getPropertyCSSValue("margin-"+aSide).cssText : "none";
  },
  
  readPaddingStyle: function(aStyle, aSide)
  {
    return aStyle ? aStyle.getPropertyCSSValue("padding-"+aSide).cssText : "none";
  },
  
  readBorderStyle: function(aStyle, aSide)
  {
    var style = aStyle ? aStyle.getPropertyCSSValue("border-"+aSide+"-style").cssText : null;
