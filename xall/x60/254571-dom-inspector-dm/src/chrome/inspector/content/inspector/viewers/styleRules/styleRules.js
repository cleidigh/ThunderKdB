...
function StyleRuleView(aObject)
{
  this.mLevel = [];
  this.mOpen = [];
  if ( Components.interfaces.nsIDOMCSSStyleSheet? aObject instanceof Components.interfaces.nsIDOMCSSStyleSheet : aObject.cssRules ) {  
	...
	if(!this.mRules.Count){
		this.mRules.Count = function(){
			return this.length;
		}
	}
	if(!this.mRules.GetElementAt){
		this.mRules.GetElementAt = function( _ind ){
			return this[_ind];
		}
	}
